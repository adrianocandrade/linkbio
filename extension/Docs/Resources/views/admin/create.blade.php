...
<div class="sandy-page-row">
    <div class="sandy-page-col pl-0">
        <div class="page__head">
            <div class="section-header mb-10">
                <div class="section-header-info">
                    <p class="section-pretitle">{{ __('New Documentation') }}</p>
                    <h2 class="section-title">{{ __('New Category') }}</h2>
                </div>
        ...
        <form method="post" action="{{ route('admin-docs-create') }}">
            @csrf
