...
class AnalyticsController extends Controller{
    public function analytics(Request $request){
        ...
        return view('admin::analytics.analytics', ['analytics' => $analytics]);
    }

    public function mostVisited(Request $request){
        $visted = Visitor::topUsers();

        return view('admin::analytics.most-visited', ['visted' => $visted]);
    }
    ...
    public function loggedIn(Request $request){
        ...
        return view('admin::analytics.loggedin', ['live' => $live, 'insight' => $insight]);
    }
