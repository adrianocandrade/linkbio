            ...
            <div class="sandy-tabs-item">
                <div class="mort-main-bg p-5 rounded-2xl">
                    ...
                    <div class="form-input mb-5">
                        ...
                        <input type="text" class="bg-w" name="name" value="{{ old('name', $plan->name ?? '') }}" placeholder="{{ __('e.g. Premium Access') }}" required>
                    </div>
                ...
                <div class="mort-main-bg p-5 rounded-2xl relative z-10 mt-5">
                    <div class="form-input mb-5">
                        ...
                        <input type="number" step="0.01" name="price" value="{{ old('price', $plan->price ?? '') }}" class="bg-w" placeholder="0.00" required>
                    </div>
                    
                    <div class="form-input">
                        <label>{{ __('Billing Cycle') }}</label>
                        <select name="billing_cycle" class="bg-w">
                            <option value="monthly" {{ old('billing_cycle', $plan->billing_cycle ?? '') == 'monthly' ? 'selected' : '' }}>{{ __('Monthly') }}</option>
                ...
                <div class="mort-main-bg p-5 rounded-2xl relative z-10 mt-5">
                    <div class="form-input">
                        ...
                        <select name="status" class="bg-w">
                            <option value="active" {{ (isset($plan) && $plan->status == 'active') ? 'selected' : '' }}>{{ __('Active') }}</option>
