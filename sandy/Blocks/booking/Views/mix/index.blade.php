...
@section('content')
<div class="wallet-page md:p-14 p-8">
    ...
    <form method="post" action="{{ route('user-mix-block-element-post', 'shop') }}">
        @csrf
    ...
    <ul class="pricing-lists my-7 hidden">
        <li class="mt-3">
            <a href="{{ route('sandy-blocks-shop-mix-shipping-index') }}" class="text-xs flex items-center">
                {!! svg_i('hand-truck-1', 'w-7 h-7 mr-2 hidden') !!}
                <i class="sio shopping-icon-020-luggage-cart icon text-2xl sligh-thick mr-2"></i>
                <span class="underline">{{ __('Store Shipping') }}</span>
            </a>
        </li>
        <li class="mt-3">
            <a href="{{ route('sandy-blocks-shop-mix-orders') }}" class="text-xs flex items-center">
                {!! svg_i('retail-bag-2', 'w-7 h-7 mr-2 hidden') !!}
                <i class="sio shopping-icon-011-shopping-bag icon text-2xl sligh-thick mr-2"></i>
                <span class="underline">{{ __('Store Orders') }}</span>
            </a>
        </li>
        <li class="mt-3">
            <a href="{{ route('sandy-blocks-shop-mix-settings') }}" class="text-xs flex items-center">
                {!! svg_i('cogwheel-1', 'w-6 h-6 mr-2 hidden') !!}
                <i class="sio design-and-development-025-settings icon text-2xl sligh-thick mr-2"></i>
                <span class="underline">{{ __('Store Settings') }}</span>
            </a>
        </li>
    </ul>
    ...
    <div class="grid grid-cols-2 gap-4 sortable" data-delay="150" data-route="{{ route('sandy-blocks-shop-mix-sort') }}">
        <a class="short-product-card is-upload disabled" href="{{ route('sandy-blocks-shop-mix-new-product') }}">
