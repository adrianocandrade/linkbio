...
namespace Sandy\Blocks\image\Livewire;
...
class BlockWire extends Component
{
    ...
    protected $rules = [
        ...
        'blocks.*.content.caption' => 'required',
        'blocks.*.content.alt' => 'required',
    ...
    public function edit($id, $index){
        ...
        $content = [
            'caption' => ao($this->blocks[$index], 'content.caption'),
            'alt' => ao($this->blocks[$index], 'content.alt'),
            'link' => addsitescheme(ao($this->blocks[$index], 'content.link'))
        ];
    ...
    public function render()
    {
        ...
        return view('Blocks-image::livewire');
    }
}
