<div class="mort-main-bg p-5 rounded-2xl mt-5">
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
		...
		<label class="sandy-big-checkbox">
			<input type="radio" name="data[type]" class="sandy-input-inner" data-placeholder-input="#video-link" data-placeholder="{{ ao($value, 'placeholder') }}" {{ $key == 'youtube' ? 'checked' : '' }} value="{{ $key }}">
	...
	<div class="form-input">
		...
		<input type="text" name="data[link]" class="bg-w" id="video-link">
	</div>
