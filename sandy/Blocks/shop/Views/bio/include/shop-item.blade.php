<?php
    $rating = \Sandy\Blocks\shop\Models\ProductReview::where('product_id', $item->id)->avg('rating');
    $variation = \Sandy\Blocks\shop\Models\ProductOption::where('product_id', $item->id)->first();
?>
...
<div class="product-card-v2">
    ...
    <a href="<?= \Bio::route($item->user, 'sandy-blocks-shop-single-product', ['id' => $item->id]) ?>" class="product-card-v2-link pb-0">
