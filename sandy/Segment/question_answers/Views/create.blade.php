...
@section('content')
<form action="{{ route("sandy-app-question_answers-create") }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="mt-5 mort-main-bg rounded-2xl p-5">
            ...
            <div class="flex justify-between">
                ...
                <label class="sandy-switch">
                    ...
                    <input class="sandy-switch-input" name="content[show_unanswered]" value="1" type="checkbox">
                    ...
                    <div class="grid grid-cols-1 gap-4 mt-5">
                        <div class="form-input is-link always-active active bg-white">
                            ...
                            <div class="is-link-inner">
                                ...
                                <input type="number" name="content[price][price]" value="1" class="bg-w">
                            </div>
                        </div>
                    </div>
                </div>
