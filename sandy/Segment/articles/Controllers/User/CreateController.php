...
namespace Sandy\Segment\articles\Controllers\User;
...
class CreateController extends Controller{
    ...
    public function createPost(Request $request){
        ...
        if (ao($content, 'paywall.enable') == 'enable') {
            $request->validate([
                'content.paywall.price' => 'required|min:1|numeric',
                'content.paywall.limit_words' => 'required|min:1|numeric'
            ]);
        }
