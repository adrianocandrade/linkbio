...
@stop
@section('content')
<form action="{{ route("sandy-app-articles-create") }}" class="mix-padding-10" method="post" enctype="multipart/form-data">
    @csrf
    <div class="mt-5 mort-main-bg rounded-2xl p-5">
        ...
        <div class="form-input mb-0">
            ...
            <input type="text" class="bg-w" name="content[ttr]">
        </div>
    </div>
    <div class="mt-5 mort-main-bg rounded-2xl p-5">
        ...
        <div class="form-input mb-5">
            ...
            <select name="content[paywall][enable]" class="bg-w" data-sandy-select=".select-shift">
                ...
                <option value="disable">{{ __('Disable / Free') }}</option>
            </select>
        </div>
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="form-input is-link always-active active bg-white">
                        ...
                        <div class="is-link-inner">
                            ...
                            <input type="number" name="content[paywall][price]" value="1" class="bg-w">
                        </div>
                    </div>

                    <div class="form-input">
                        <label class="initial">{{ __('Limit words') }}</label>
                        <input type="text" name="content[paywall][limit_words]" value="10" class="bg-w">
                    </div>
    ...
    <div class="mort-main-bg rounded-2xl p-5 mt-5">
        ...
        <div class="form-input bio-tox">
            ...
            <textarea name="content[description]" class="bg-w editor"></textarea>
        </div>
    </div>
