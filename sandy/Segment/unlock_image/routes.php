...
Route::get('{slug}/get-blured-image', 'Controllers\RenderController@getBluredImage')->name('render-image-blured');

// Payment
Route::post('{slug}/unlock', 'Controllers\RenderController@unlockPayment')->name('unlock');
Route::get('{slug}/unlock-callback', 'Controllers\RenderController@unlock_callback')->name('unlock-callback');