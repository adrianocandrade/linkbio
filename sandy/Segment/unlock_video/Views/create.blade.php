...
@section('content')
<form action="{{ route("sandy-app-unlock_video-create") }}" class="mix-padding-10" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mt-5 mort-main-bg rounded-2xl p-5">
        ...
        <div class="form-input mt-3">
            ...
            <p class="mt-0 mb-5 text-xs c-gray">( {{__('Note: Image / Video should not exceed :mb in size.', ['mb' => Elements::config('unlock_video', 'config.image_size.value') .'mb']) }})</p>
        </div>
    </div>
    <div class="mt-5 mort-main-bg rounded-2xl p-5">
        ...
        <div class="form-input mb-5">
            ...
            <select name="content[price][type]" class="bg-w" data-sandy-select=".select-shift">
                ...
                <option value="customers">{{ __('Let customers pay') }}</option>
            </select>
        </div>
    ...
    <div class="mt-5 mort-main-bg rounded-2xl p-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
            ...
            <label class="sandy-big-checkbox">
                <input type="radio" name="content[video][type]" class="sandy-input-inner" data-placeholder-input="#video-link" data-placeholder="{{ ao($value, 'placeholder') }}" {{ $key == 'youtube' ? 'checked' : '' }} value="{{ $key }}">
        ...
        <div class="form-input mb-0">
            ...
            <input type="text" name="content[video][link]" class="bg-w" id="video-link">
        </div>
        <div class="mt-4">
