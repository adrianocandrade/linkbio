...
namespace Sandy\Segment\unlock_video\Controllers;
...
class RenderController extends Controller{
    ...
    public function purchase($slug, Request $request){
        ...
        if (ao($this->element->content, 'price.type') == 'customers') {
        ...
        //
        $callback = route('sandy-app-unlock_video-purchase-callback', ['slug' => $this->element->slug, 'sxref' => $sxref]);
