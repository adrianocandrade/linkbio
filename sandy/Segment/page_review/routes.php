...
Route::get('accept/{slug}/{id}', 'Controllers\User\EditController@accept_review')->name('accept-review');
...
// Send Message
Route::post('{slug}/message', 'Controllers\RenderController@leaveReview')->name('send');