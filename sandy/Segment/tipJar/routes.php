...
// Tip User
Route::post('{slug}/tip', 'Controllers\RenderController@TipUser')->name('tip-user');
// Callback
Route::get('{slug}/callback', 'Controllers\RenderController@tipUserCallback')->name('tip-user-callback');